const initialState = {
  ...
  tokenInformation: {
    ...
    1: {
      title: 'limbo',
      description: 'The spirits of great men and women who claim to work in crypto remain suspended here in Limbo, the First Circle of Crypto Hell. Here lie the conference junkies, social media professors, and meet-up evangelists whose praises and condemnations have followed the whims of a volatile crypto market. This circle is characterized by weak hands holding crypto on exchange, hands that have never held a mobile wallet or touched a dApp. Their eternal status is, “Waiting for your response” on LinkedIn.',
    },
    2: {
      title: 'lust',
      description: 'Those who exchanged crypto in the sole pursuit of pleasure find themselves trapped in The Second Circle of Crypto Hell. This seedy layer is home to individuals whose desires were left unquenched by goods and services available for sale on the clear web. Using crypto to buy illicit drugs, stolen credit cards, and jailbait on dark web markets, these sinners suffer quietly in Incognito Mode, clicking on dead .onion links and living in constant paranoia of receiving an unwelcome knock on their door.',
    },
    3: {
      title: 'gluttony',
      description: 'The gluttonous souls of the crypteau-riche languish in mediocrity in the Third Circle of Crypto Hell. Once active, contributing members of the community, these softbellies no longer reply to e-mails because their inboxes are filled with receipts from Uber, Airbnb, and Amazon. It is nearly impossible to move here due to the ungodly amount of Lambo traffic. “I had that idea years ago,” the sinners cry helplessly, as they twist the top off the latest nootropic capsule and pour it directly into a cup of cold brew coffee.',
    },
    4: {
      title: 'avarice',
      description: 'The more enterprising strain of crypteau-riche continue to claw their way into the the Fourth Circle of Crypto Hell, Avarice. Here, sinners who hoarded and spent their cryptocurrency wastefully are unable to escape the swarm of lucrative opportunities which engulfs them, represented in this circle by purple bees with golden stingers. Reaching for every opportunity that flies their way, the greedy swollen with welts and glimmering with golden needles of dead bees run directionless for all of eternity.'
    },
    5: {
      title: 'wrath',
      description: 'In the Fifth Circle of Crypto Hell, we hear the echoes of wrathful developers, voices raging as they try to sync a node to the blockchain. Cascading error messages etch themselves into terminal walls blacker than night behind closed eyelids, whispering unforgivable things into their ears as they sleep: invalid nonce, pending transaction, OUT OF GAS. Consumed by a furious anger, these sinners boil in their own blood as they are forced to watch a Client Syncing animation until the end of time.'
    },
    6: {
      title: 'heresy',
